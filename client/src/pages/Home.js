            ...
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                  Welcome to myCryptoTracker
                </h1>
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  <ul><li>Track your favourite cryptocurrencies.</li> <li>Add them to your Watchlist.</li>
                  <li> Compare them.</li></ul>
                </p>
                <p className="mt-8 md:mt-12">
                  <h1
                    className=" py-4 px-12 bg-blue-400 text-white"
                  >
                    Get Started. LogIn from the top or make a new account TODAY.
                  </h1>
                </p>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Features a user-friendly UI designed for effortless navigation and ease of use. 
                    Enjoy clear layouts, and responsive design that adapts to your needs.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Watchlist your favorite currencies with ease, keeping track of their performance and updates effortlessly.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Watchlist your favorite currencies and compare them for maximum profits, 
                    making informed decisions with real-time performance insights.
                    </p>
                  </div>
                </div>
              </div>
